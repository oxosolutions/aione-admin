...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array (
            ...
            'subtitle'  => __('Number of posts to display per page.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Layout for only the archive/category pages.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Amount of spacing between portfolio items.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Sidebar that will be added to the archive/category pages.', 'redux-framework-demo'),
            'desc' => __('Select the sidebar that will be added to the archive/category pages.','redux-framework-demo'),
            'default' => 'None',
            'hint' => array(
                'title'   => __('Portfolio Archive/Category Sidebar','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __(' 
Choose to display an excerpt or full portfolio content on archive / portfolio pages.', 'redux-framework-demo'),
            'desc' => __('Note: The "Full Content" option will override the page excerpt settings.','redux-framework-demo'),
            'default' => 'Excerpt',
            'hint' => array(
                'title'   => __('Excerpt or Full Portfolio Content','redux-framework-demo'),
		...
		array (
				...
				'subtitle'  => __('if you want to strip HTML from the excerpt content only.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Pagination type for Portfolio layouts.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Select if the portfolio text layouts are boxed or unboxed.', 'redux-framework-demo'),
            'desc' => __('Choose portfolio text layout','redux-framework-demo'),
            'default' => 'unboxed',
            'hint' => array(
                'title'   => __('Portfolio Text Layout','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Select Portfolio Featured Image Size', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Display featured images and videos on single post pages.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Disable the 1st featured image on single post pages.', 'redux-framework-demo'),
            'desc' => __('YES to Disable the 1st featured image on single post pages.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Disable First Featured Image','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Set Width of Content Columns for Featured Image', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Set posts to 100% browser width.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Show or hide the project description title.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Show or hide the project details text.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Open the single post page, project url and copyright url links in a new window.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enable comments on portfolio items..', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enable Author on portfolio items.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Display the social sharing box.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Display related posts.', 'redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
        array (
            ...
            'subtitle'  => __('This option controls the number of featured image boxes for blog/portfolio slideshows.', 'redux-framework-demo'),
            'desc' => __('Enter number of featured image boxes for blog/portfolio slideshows.','redux-framework-demo'),
            'default' => '5',
            'hint' => array(
                'title'   => __('Posts Slideshow Images','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enables Autoplay option.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enable Smooth Height on slideshows when using images with different heights.', 'redux-framework-demo'),
            'desc' => __('YES to enable smooth height. Please note, smooth height is disabled on blog grid layout.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Enable Smooth Height','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Controls the speed of slideshows for the [slider] shortcode and sliders within posts.', 'redux-framework-demo'),
            'desc' => __('eg: 1000 = 1 second.','redux-framework-demo'),
            'default' => '7000',
            'hint' => array(
                'title'   => __('Slideshow speed','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enables Pagination circles below video slides for slider shortcode.', 'redux-framework-demo'),
            'desc' => __('YES if you want to show pagination circles. Leave it unchecked to hide them on video slides.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Pagination circles below video slides','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select Navigation Box Width', 'redux-framework-demo'),
            'desc' => __('Enter a pixel value for width, eg: 30px','redux-framework-demo'),
            'default' => '30px',
            'hint' => array(
                'title'   => __('Navigation Box Width','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select Navigation Box Height', 'redux-framework-demo'),
            'desc' => __('Enter a pixel value for height, eg: 30px','redux-framework-demo'),
            'default' => '30px',
            'hint' => array(
                'title'   => __('Navigation Box Height','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Select Navigation Arrow Size', 'redux-framework-demo'),
            'desc' => __('Enter a pixel value for the arrow size, eg: 14px','redux-framework-demo'),
            'default' => '14px',
            'hint' => array(
                'title'   => __('Navigation Arrow Size','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
        array (
            ...
            'subtitle'  => __('Choose Width of Slider.', 'redux-framework-demo'),
            'desc' => __('In pixels or percentage, eg: 100% or 100.','redux-framework-demo'),
            'default' => '100%',
            'hint' => array(
                'title'   => __('Slider Width','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Choose Height of Slider.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select Slider Animation type .', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select the slideshow speed.', 'redux-framework-demo'),
            'desc' => __('1000 = 1 second.','redux-framework-demo'),
            'default' => '3000',
            'hint' => array(
                'title'   => __('Slideshow Interval','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select the animation speed.', 'redux-framework-demo'),
            'desc' => __('1000 = 1 second.','redux-framework-demo'),
            'default' => '800',
            'hint' => array(
                'title'   => __('Sliding Speed','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select the width of Thumbnail.', 'redux-framework-demo'),
            'desc' => __('without \'px\' eg: 100.','redux-framework-demo'),
            'default' => '150',
            'hint' => array(
                'title'   => __('Thumbnail Width','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Choose Title Font Size (px).', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Choose Caption Font Size (px).', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Choose the text color of the title font.', 'redux-framework-demo'),
            'desc' => __('Choose the Title Color','redux-framework-demo'),
            'default' => '#333333',
            'hint' => array(
                'title'   => __('Title Color','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Controls the text color of the caption font.', 'redux-framework-demo'),
            'desc' => __('Choose the Caption Color','redux-framework-demo'),
            'default' => '#747474',
            'hint' => array(
                'title'   => __('Caption Color','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Select what the lightbox will display for portfolio and blog posts.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Choose Lightbox Skin.', 'redux-framework-demo'),
            'desc' => __('Select a skin from the list for the lightbox.','redux-framework-demo'),
            'options' => array (
                'light' => 'Light',
                'dark'  => 'Dark', 
				'mac'   => 'Mac',
		...
		array (
            ...
            'subtitle'  => __('Select Thumbnails Position', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Select Animation Speed.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Enables Arrows', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enables Gallery Start/Stop Button', 'redux-framework-demo'),
        ...
        array (
            ...
            'type' => 'text',
            'title' => __('Slideshow Speed','redux-framework-demo'),
            'subtitle'  => __('Select Slideshow Speed.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Select Background Opacity.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Show Title in the Lightbox.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Show Caption in the Lightbox.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enables Social Sharing buttons on Lightbox.', 'redux-framework-demo'),
            'desc' => __('YES to show social sharing buttons.','redux-framework-demo'),
            'hint' => array(
            'title'   => __('Social Sharing','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Enables Deeplinking in the Lightbox.', 'redux-framework-demo'),
            'desc' => __('YES to deeplink images.','redux-framework-demo'),
            'hint' => array(
				'title'   => __('Deeplinking','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enables Post Images that are inside the post content area in Lightbox.', 'redux-framework-demo'),
            'desc' => __('YES to show post images.','redux-framework-demo'),
           'hint' => array(
           'title'   => __('Show Post Images in Lightbox','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Set the width that will be used for videos inside the lightbox.', 'redux-framework-demo'),
            'desc' => __(' In pixel, eg: 800px','redux-framework-demo'),
			'default' => '1280px',
            'hint' => array(
				'title'   => __('Slideshow Video Width','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Set the height that will be used for videos inside the lightbox.', 'redux-framework-demo'),
            'desc' => __(' In pixel, eg: 600px','redux-framework-demo'),
			'default' => '720px',
            'hint' => array(
				'title'   => __('Slideshow Video Height','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Controls the side navigation animation for child pages, on click or hover.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Enable the showing of posts without a featured image on portfolio archives and related posts/projects carousels.', 'redux-framework-demo'),
            'desc' => __('Yes to enable.','redux-framework-demo'),
			'on' => __('YES', 'redux-framework-demo'),
			'off' => __('NO ', 'redux-framework-demo'),
			'default'   => true,
            'hint' => array(
        ...
        array (
            ...
            'subtitle'  => __('Disable the read more sign [...] on excerpts throughout the site.', 'redux-framework-demo'),
            'desc' => __('YES to disable.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Disable [...] on Excerpts','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('To have the read more sign [...] on excerpts link to single post page.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Allow comments on regular pages.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Show featured images on FAQ archive page.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Choose to show or hide filters, or to display them without "All".', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('This option controls the height of all search, form input and select fields.', 'redux-framework-demo'),
            'desc' => __('eg: 20px.','redux-framework-demo'),
			'default' => '29px',
            'hint' => array(
                'title'   => __('Form Input and Select Height','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('This option controls the quality of the generated image sizes for every uploaded image. 
                            Ranges between 0 and 100 percent. Higher values lead to better image qualities but also higher file sizes.', 'redux-framework-demo'),
            'desc' => __('NOTE: After changing this value, please (install and) run Regenerate Thumbnails
		...
		array (
            ...
            'type' => 'text',
            'title' => __('Number of Related Posts / Projects','redux-framework-demo'),
            'subtitle'  => __('This option controls the amount of related posts / projects that show up on each single portfolio and blog post.', 'redux-framework-demo'),
            'desc' => __('eg: 5','redux-framework-demo'),
			'default' => '5',
            'hint' => array(
                'title'   => __('Number of Related Posts / Projects','redux-framework-demo'),
                'content' => __('Number of Related Posts / Projects','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Used  to display the number of max columns.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Insert the amount of spacing between items.', 'redux-framework-demo'),
            'desc' => __('Insert the amount of spacing between items without "px". eg: 40','redux-framework-demo'),
			'default' => '44',
            'hint' => array(
                'title'   => __('Related Posts / Projects Column Spacing','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Show titles on rollover image, or below image.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Choose if the images are fixed (cropped) or auto (full image ratio) for related posts / projects.', 'redux-framework-demo'),
            'desc' => __('IMPORTANT: Fixed images work best with smaller site widths. Auto images work best with larger site widths.','redux-framework-demo'),
            'options' => array (
                'cropped' => 'Fixed',
                'full' => 'Auto',
            ),
		...
		array (
            ...
            'subtitle'  => __('Enable to autoplay on the carousel.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Controls the speed of all carousel elements.', 'redux-framework-demo'),
            'desc' => __('eg: 1000 = 1 second.','redux-framework-demo'),
			'default' => '2500',
            'hint' => array(
                'title'   => __('Related Posts / Projects Speed','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Enable navigation buttons on the carousel.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Enable mouse drag control on the carousel.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Show the rollover box on images.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Set the Rollover Image Direction', 'redux-framework-demo'),
            ...
            'default' => 'left',
            'required' =>  array('image_rollover','equals','1'),
            'hint' => array(
                'title'   => __('Rollover Image Direction','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Controls the font size of the icons in the rollover.', 'redux-framework-demo'),
            'desc' => __('In pixels, default is 15.','redux-framework-demo'),
			'default' => '15',
            'required' =>  array('image_rollover','equals','1'),
            'hint' => array(
                'title'   => __('Rollover Image Icon Font Size','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Disable the link icon from image rollovers. Note: This option will override the post settings.', 'redux-framework-demo'),
            'desc' => __('YES to disable the link icon from image rollovers.','redux-framework-demo'),
            'required' =>  array('image_rollover','equals','1'),
            'hint' => array(
                'title'   => __('Disable Link Icon From Image Rollover','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Disable the image icon from image rollovers. Note: This option will override the post settings.', 'redux-framework-demo'),
            'desc' => __('YES to disable the image icon from image rollovers.','redux-framework-demo'),
            'required' =>  array('image_rollover','equals','1'),
            'hint' => array(
                'title'   => __('Disable Image Icon From Image Rollover','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Controls the padding inside the box.', 'redux-framework-demo'),
            'desc' => __('eg: 10px or 10%.','redux-framework-demo'),
			'default' => '2px 6px',
            'hint' => array(
                'title'   => __('Pagination Box Padding','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Controls if "Previous" and "Next" text is displayed or not.', 'redux-framework-demo'),
            'desc' => __('YES to display Pagination Text.','redux-framework-demo'),
            'hint' => array(
				'title'   => __('Pagination Text Display','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('This will remove the dark scrollbar and revert to the default browser scrollbar style.', 'redux-framework-demo'),
            'desc' => __('YES to disable smooth scrolling.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Disable Smooth Scrolling','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Disable the Page builder button on pages/posts.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Disable encoding in the Page Builder code block element.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Disable the aione styles and use the default Revolution Slider styles.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('This option adds UberMenu support without editing any code.', 'redux-framework-demo'),
            'desc' => __('YES if you are using UberMenu.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('UberMenu Plugin Support','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Disable the ToTop script which adds the scrolling to top functionality.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Disable product gallery slider that is built-in with Aione. This is only useful for plugin compatibility.', 'redux-framework-demo'),
            'desc' => __('YES to disable product gallery slider that is built-in with Aione.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Disable Aione Woocommerce Product Gallery Slider','redux-framework-demo'),
