...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array(
            ...
            //'compiler'      => array('#site_description'), // An array of CSS selectors to apply this font style to dynamically
            'units'         => 'px', // Defaults to px
            'subtitle'      => __('Font options for main menu.', 'redux-framework-demo'),
            'desc' =>  __('Header Main Menu.','redux-framework-demo'),
            'default'       => array(
                'font-weight'    => '300',
                'font-family'   => 'Arial, Helvetica, sans-serif',
                'google'        => true,
            ...
            'hint' => array(
                'title'   => __('Header Main Menu','redux-framework-demo'),
                'content' => __('Header Main Menu','redux-framework-demo'),
            )
        ),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array(
            ...
            'units'         => 'px', // Defaults to px
            'subtitle'      => __('Font style for H4.', 'redux-framework-demo'),
            'desc' =>  __('Heading H4.','redux-framework-demo'),
            'default'       => array(
                'font-family'   => 'Arial, Helvetica, sans-serif',
                'google'        => true,
                'font-size'     => '20',
            ...
            'hint' => array(
                'title'   => __('Heading H4','redux-framework-demo'),
                'content' => __('Heading H4','redux-framework-demo'),
            )
        ),
    )
);
...
$this->sections[] = array(
    ...
    'fields'    => array(
        array(
            ...
            //'compiler'      => array('#main h1'), // An array of CSS selectors to apply this font style to dynamically
            'units'         => 'px', // Defaults to px
            'subtitle'      => __('Font style for footer H1.', 'redux-framework-demo'),
            'desc' =>  __('Footer Widget Heading Font Size.','redux-framework-demo'),
            'default'       => array(
                'font-family'   => 'Arial, Helvetica, sans-serif',
                'google'        => true,
                'font-size'     => '13',
            ...
            'hint' => array(
                'title'   => __('Footer Widget Heading Font Size','redux-framework-demo'),
                'content' => __('Footer Widget Heading Font Size','redux-framework-demo'),
            )
        ),
		array(
            ...
            //'compiler'      => array('#main h1'), // An array of CSS selectors to apply this font style to dynamically
            'units'         => 'px', // Defaults to px
            'subtitle'      => __('Font style for Copyright.', 'redux-framework-demo'),
            'desc' =>  __('Copyright Font Size.','redux-framework-demo'),
            'default'       => array(
                'font-family'   => 'Arial, Helvetica, sans-serif',
                'google'        => true,
                'font-size'     => '12',
            ...
            'hint' => array(
                'title'   => __('Copyright Font Size','redux-framework-demo'),
                'content' => __('Copyright Font Size','redux-framework-demo'),
            )
        ),
