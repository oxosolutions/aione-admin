...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array (
            ...
            'id' => 'font_other',
            'type' => 'typography',
            'title' =>  __('Additional fonts', 'redux-framework-demo'),
            'subtitle'  => __('Select the additional font families you want to embedd.', 'redux-framework-demo'),
            'desc' => __('Select the font family from given options. Default value is <strong>Open Sans</strong>.', 'redux-framework-demo'),
            'font-family'     => true,
            'font-size'       => false,
            'font-weight'     => false,
            'font-style'      => false,
