...
$this->sections[] = array(
    ...
    'fields'    => array(
        array (
            ...
            'subtitle'  => __('Header Position', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Header Width For Left/Right Position', 'redux-framework-demo'),
            'desc' => __('Controls width of the left or right side header. In pixels, ex: 170px.','redux-framework-demo'),
            'default' => '280px',
            'hint' => array(
                'title'   => __('Header Width For Left/Right Position','redux-framework-demo'),
		...
		array (
				...
				'subtitle'  => __('100% Header Width.', 'redux-framework-demo'),
				'desc' => __('Set Yes to set the header to 100% of the browser width. Uncheck to follow site width. Only works with wide layout mode.', 'redux-framework-demo'),
        ...
        */
		...
		array (
            ...
            'subtitle'  => __('Header Left Padding.', 'redux-framework-demo'),
            'desc' => __('In pixels, ex: 10px','redux-framework-demo'),
            'default' => '0px',
            'hint' => array(
                'title'   => __('Header Left Padding','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Header Right Padding.', 'redux-framework-demo'),
            'desc' => __('In pixels, ex: 10px','redux-framework-demo'),
            'default' => '0px',
            'hint' => array(
                'title'   => __('Header Right Padding','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array(
            ...
            'subtitle'      => __( 'Header Social Icons Font Size', 'redux-framework-demo' ),
		...
		array (
            ...
            'subtitle'  => __('Header Social Icons Boxed Padding.', 'redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Headers 4-5 Sticky Header Display', 'redux-framework-demo'),
            'desc' => __('Select if your sticky header shows the menu or menu + logo area.','redux-framework-demo'),
            'options' => array (
                'menu_only' => 'Menu Only',
...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array (
            ...
            'subtitle'  => __('Logo Width.', 'redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Logo Height.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Select Mobile Logo Image.', 'redux-framework-demo'),
            'desc' => __('Select an image file for your logo.','redux-framework-demo'),
            'default' => array (
                'url' => AIONE_PLUGIN_URL. '/assets/images/logo.png',
            ),
		...
		array (
            ...
            'subtitle'  => __('Mobile Logo Width.', 'redux-framework-demo'),
            'desc' => __('If retina logo is uploaded, enter the standard logo (1x) version width, do not enter the retina logo width.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Mobile Logo Width','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Mobile Logo Height.', 'redux-framework-demo'),
            'desc' => __('If retina logo is uploaded, enter the standard logo (1x) version height, do not enter the retina logo height.','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Mobile Logo Height','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Menu Text Align.', 'redux-framework-demo'),
            'desc' => __('Controls the alignment of the text in the menu for top headers 4-5 and side headers.','redux-framework-demo'),
            'options' => array (
                'left' => 'Left',
                'center' => 'Center',
                'right' => 'Right',
		...
		array(
            ...
            'desc'          => __( 'In pixels, ex: 7px', 'redux-framework-demo' ),
            'default'       => '7px',
            'hint' => array(
                'title'   => __( 'Main Menu Dropdown Item Top/Bottom Padding', 'redux-framework-demo' ),
                'content' => __( 'In pixels, ex: 7px', 'redux-framework-demo' ),
            ),
        ),
		array (
            ...
            'subtitle'  => __('Main Menu Dropdown Item Divider.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Dropdown Menu Indicator.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Mobile Menu Design Style', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'      => __( 'Mobile Menu Item Padding', 'redux-framework-demo' ),
            'desc' => __('Controls right (left on RTL) menu padding on mobile devices when the normal menu is used. Use a number without "px", default is 25. ex: 25','redux-framework-demo' ),
            'default' => '25',
            'hint' => array(
                'title'   => __( 'Mobile Menu Item Padding', 'redux-framework-demo' ),
                'content' => __( 'Controls right (left on RTL) menu padding on mobile devices when the normal menu is used. Use a number without "px", default is 25. ex: 25', 'redux-framework-demo' ),
            ),
        ),
		array (
            ...
            'subtitle'  => __('Mobile Menu Text Align.', 'redux-framework-demo'),
            'desc' => __('Controls the alignment of menu text on mobile menu.','redux-framework-demo'),
            'options' => array (
                'left' => 'Left',
                'center' => 'Center',
                'right' => 'Right',
		...
		array (
            ...
            'subtitle'      => __( 'Mobile Menu Icons Top Margin', 'redux-framework-demo' ),
            'desc' => __('Controls the top margin for the icons in the modern mobile menu sticky header. In pixels, ex: 100px','redux-framework-demo' ),
            'default' => '0px',
            'hint' => array(
                'title'   => __( 'Mobile Menu Icons Top Margin', 'redux-framework-demo' ),
                'content' => __( 'Controls right (left on RTL) menu padding on mobile devices when the normal menu is used. Use a number without "px", default is 25. ex: 25', 'redux-framework-demo' ),
		...
		array (
            ...
            'subtitle'      => __( 'Mobile Menu Navigation Height', 'redux-framework-demo' ),
            'desc' => __('Controls the menu height of each menu item. Use a number without "px", default is 35.','redux-framework-demo' ),
            'default' => '35',
            'hint' => array(
                'title'   => __( 'Mobile Menu Navigation Height', 'redux-framework-demo' ),
                'content' => __( 'Controls right (left on RTL) menu padding on mobile devices when the normal menu is used. Use a number without "px", default is 25. ex: 25', 'redux-framework-demo' ),
