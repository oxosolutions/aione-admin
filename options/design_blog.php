...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Grid Layout Column Spacing.', 'redux-framework-demo'),
            'desc' => __('Insert the amount of spacing between grid items without "px". ex: 40.','redux-framework-demo'),
			'default' => '40',
            'hint' => array(
                'title'   => __('Grid Layout Column Spacing','redux-framework-demo'),
