...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array (
            ...
            'subtitle'  => __('Disable Context Menu.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Disable  Cut Copy Paste.', 'redux-framework-demo'),
            'desc' => __('Default value is <strong>YES</strong>.', 'redux-framework-demo'),
            'on' => __('YES', 'redux-framework-demo'),
            'off' => __('NO ', 'redux-framework-demo'),
            'default'   => false,
        ...
        array (
            ...
            'subtitle'  => __('Disable Drag and Drop of Images.', 'redux-framework-demo'),
            'desc' => __('Default value is <strong>YES</strong>.', 'redux-framework-demo'),
            'on' => __('YES', 'redux-framework-demo'),
            'off' => __('NO ', 'redux-framework-demo'),
            'default'   => false,
        ...
        array (
            ...
            'subtitle'  => __('Disable iframe Inclusion.', 'redux-framework-demo'),
            'desc' => __('Default value is <strong>YES</strong>.', 'redux-framework-demo'),
            'on' => __('YES', 'redux-framework-demo'),
            'off' => __('NO ', 'redux-framework-demo'),
            'default'   => false,
