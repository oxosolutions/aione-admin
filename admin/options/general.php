...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array(
            ...
            'desc' => __('Use CSS class <strong>primary</strong> to use this color.. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes. ', 'redux-framework-demo'),
            'default'  => '#333333',
            'validate' => 'color',
            'transparent' => false,
        ...
        array(
            ...
            'desc' => __('Use CSS class <strong>secondary</strong> to use this color. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes. ', 'redux-framework-demo'),
            'default'  => '#595959',
            'transparent' => false,
            'validate' => 'color',
            'required' => array('color_scheme','!=','custom'),
        ...
        array(
            ...
            'desc' => __('Use CSS class <strong>highlight</strong> to use this color. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes. ', 'redux-framework-demo'),
            'default'  => '#212121',
            'transparent' => false,
            'validate' => 'color',
            'required' => array('color_scheme','!=','custom'),   
        ...
        array(
            ...
            'desc' => __('Use CSS class <strong>bg-highlight</strong> to use this background color. <a href="https://tools.darlic.com/colors.php"> Click here</a> for color codes. ', 'redux-framework-demo'),
            'default'  => '#333333',
            'transparent' => false,
            'validate' => 'color',
            'required' => array('color_scheme','!=','custom'),
