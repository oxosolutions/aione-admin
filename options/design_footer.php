...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('100% Footer Width.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Footer Special Effects', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Sticky Footer Height.', 'redux-framework-demo'),
            'desc' => __('The entire height of the footer area (widgets + copyright). Set a static height in px to enable sticky footer effect. ex: 200px.','redux-framework-demo'),
            'default' => '',
            'hint' => array(
                'title'   => __('Sticky Footer Height','redux-framework-demo'),
                'content' => __('The entire height of the footer area (widgets + copyright). Set a static height in px to enable sticky footer effect. ex: 200px.','redux-framework-demo'),
            )
        ),
		/*array (
		...
		array (
            ...
            'subtitle'  => __('Footer Widgets Center Content.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Footer Left Padding.', 'redux-framework-demo'),
            'desc' => __('In pixels or percentage, ex: 10px or 10%.','redux-framework-demo'),
            'default' => '0px',
            'hint' => array(
                'title'   => __('Footer Left Padding','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Footer Right Padding.', 'redux-framework-demo'),
            'desc' => __('In pixels, ex: 20px','redux-framework-demo'),
            'default' => '0px',
            'hint' => array(
                'title'   => __('Footer Right Padding','redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Footer Social Icons Font Size.', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Footer Social Icons Boxed Padding.', 'redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Copyright Center Content.', 'redux-framework-demo'),
