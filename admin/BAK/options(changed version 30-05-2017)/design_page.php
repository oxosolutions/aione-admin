...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array (
            ...
            'subtitle'  => __('View of Search Results.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Search Results Layout','redux-framework-demo'),
                'content' => __('Select the layout for the search results page.','redux-framework-demo'),
            )
        ),
		array (
            'id' => 'search_content',
            ...
            'subtitle'  => __('Content to be shown in Search Results.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Search Results Content','redux-framework-demo'),
                'content' => __('Content to be shown in Search Results.','redux-framework-demo'),
            )
        ),
		array (
            'id' => 'search_excerpt',
            ...
            'subtitle'  => __('Choose to Hide Search Results Excerpt.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Hide Search Results Excerpt','redux-framework-demo'),
                'content' => __('Choose to Hide Search Results Excerpt.','redux-framework-demo'),
            )
        ),
		array (
            ...
            'subtitle'  => __('Choose Number of Search Results to be displayed on a single page.', 'redux-framework-demo'),
            'desc' => __('Set the number of search results per page.','redux-framework-demo'),
            'default' => '10',
            'hint' => array(
                'title'   => __('Number of Search Results Per Page','redux-framework-demo'),
                'content' => __('Choose Number of Search Results to be displayed on a single page.','redux-framework-demo'),
            )
        ),
		array (
            ...
            'subtitle'  => __('Use to Hide Featured Images from Search Results.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Hide Featured Images from Search Results','redux-framework-demo'),
                'content' => __('Use to Hide Featured Images from Search Results.','redux-framework-demo'),
            )
        ),
		array (
            'id' => 'search_new_search_position',
            'type' => 'select',
            'title' => __('Search Field Position','redux-framework-demo'),
            'subtitle'  => __('Choose Position of Search Field.', 'redux-framework-demo'),
            'desc' => __('Select the position of the search bar on the search results page.','redux-framework-demo'),
            'options' => array (
            ...
            'hint' => array(
                'title'   => __('Search Field Position','redux-framework-demo'),
                'content' => __('Choose Position of Search Field.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'search_sidebar',
            ...
            'subtitle'  => __('Choose Sidebar to be displayed on Search Page.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Search Page Sidebar','redux-framework-demo'),
                'content' => __('Choose Sidebar to be displayed on Search Page.','redux-framework-demo'),
            )
        ),
        array (
            ...
            'subtitle'  => __('Select Position of Search Sidebar.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Search Sidebar Position','redux-framework-demo'),
                'content' => __('Select Position of Search Sidebar.','redux-framework-demo'),
            )
        ),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Enter the email adress the form will be sent to.', 'redux-framework-demo'),
            'desc' => __('eg: example@example.com','redux-framework-demo'),
            'hint' => array(
                'title'   => __('Email Address','redux-framework-demo'),
                'content' => __('Enter the email adress the form will be sent to.','redux-framework-demo'),
            )
        ),
		array (
            'id' => 'contact_comment_position',
            'type' => 'select',
            'title' => __('Contact Form Comment Area Position','redux-framework-demo'),
            'subtitle'  => __('Set the position of the contact form comment area with respect to the other input fields.', 'redux-framework-demo'),
            'desc' => __('Select position from list','redux-framework-demo'),
            'options' => array (
                'above' => 'Above',
                'below' => 'Below',
            ),
            ...
            'hint' => array(
                'title'   => __('Contact Form Comment Area Position','redux-framework-demo'),
                'content' => __('Set the position of the contact form comment area with respect to the other input fields.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'google_map',
        ...
        array (
            ...
            'subtitle'  => __('Select the type of google map to show on the contact page.', 'redux-framework-demo'),
            'desc' => __('Select the type of google map from the list','redux-framework-demo'),
            'options' => array (
                'roadmap' => 'roadmap',
                'satellite' => 'satellite',
                'hybrid' => 'hybrid',
            ...
            'hint' => array(
                'title'   => __('Google Map Type','redux-framework-demo'),
                'content' => __('Select the type of google map to show on the contact page.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'gmap_width',
            ...
            'subtitle'  => __('Choose Width of Google Map.', 'redux-framework-demo'),
            'desc' => __('In pixels or percentage, eg: 100% or 100px..','redux-framework-demo'),
            'default' => '100%',
            'hint' => array(
                'title'   => __('Google Map Width','redux-framework-demo'),
                'content' => __('Choose Width of Google Map.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'gmap_height',
            ...
            'subtitle'  => __('Choose Height of Google Map.', 'redux-framework-demo'),
            'desc' => __('In pixels, eg: 100px.','redux-framework-demo'),
            'default' => '415px',
            'hint' => array(
                'title'   => __('Google Map Height','redux-framework-demo'),
                'content' => __('Choose Height of Google Map.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'gmap_topmargin',
            ...
            'subtitle'  => __('Choose Google Map Top Margin.', 'redux-framework-demo'),
            ...
            'hint' => array(
                'title'   => __('Google Map Top Margin','redux-framework-demo'),
                'content' => __('Choose Google Map Top Margin.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'gmap_address',
            ...
            'desc' => __('Single address eg: 775 New York Ave, Brooklyn, Kings, New York 11203. <br />For multiple markers, separate the addresses with the | symbol.<br /> ex: Address 1|Address 2|Address 3.','redux-framework-demo'),
        ...
        array (
            ...
            'subtitle'  => __('Choose Map Zoom Level.', 'redux-framework-demo'),
            'desc' => __('Higher number indicates higher zoom in.','redux-framework-demo'),
            'default' => '8',
            'hint' => array(
                'title'   => __('Map Zoom Level','redux-framework-demo'),
                'content' => __('Choose Map Zoom Level.','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'map_pin',
            ...
            'desc' => __('YES to Hide the address pin.','redux-framework-demo'),
            'on' => __('YES', 'redux-framework-demo'),
            'off' => __('NO ', 'redux-framework-demo'),
            'default'   => false,
            'hint' => array(
