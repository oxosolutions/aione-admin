...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Activate Global Sidebar', 'redux-framework-demo'),
            'desc' => __('Yes if you want to use a global sidebar on all pages. This option overrides the page options.','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Global Sidebar 1', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Global Sidebar 2', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Global Sidebar Position', 'redux-framework-demo'),
		...
		array (
            ...
            'title' => __('Global Sidebar 2','redux-framework-demo'),
            'subtitle'  => __('Global Sidebar 2', 'redux-framework-demo'),
            'desc' => __('Select sidebar 2 that will display on all single portfolio posts. Sidebar 2 can only be used if sidebar 1 is selected','redux-framework-demo'),
            'options' => aione_get_sidebars(),
			'default' => 'None',
			'hint' => array(
                'title'   => __('Global Sidebar 2','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Global Portfolio Sidebar Position', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Portfolio Archive/Category Sidebar 1', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Portfolio Archive/Category Sidebar 2', 'redux-framework-demo'),
		...
		array (
            ...
            'title' => __('Activate Global Sidebar','redux-framework-demo'),
            'subtitle'  => __('Activate Global Sidebar', 'redux-framework-demo'),
            'desc' => __('Yes f you want to use a global sidebar on all single posts. This option overrides the post options.','redux-framework-demo'),
            'on' => __('YES', 'redux-framework-demo'),
            'off' => __('NO ', 'redux-framework-demo'),
            'default' => 'No',
            'hint' => array(
		...
		array (
            ...
            'title' => __('Global Sidebar Position','redux-framework-demo'),
            'subtitle'  => __('Global Sidebar Position', 'redux-framework-demo'),
            'desc' => __('Select the sidebar 1 position for the blog pages. If sidebar 2 is selected, it will display on the opposite side.','redux-framework-demo'),
            'default' => 'Right',
            'hint' => array(
                'title'   => __('Global Sidebar Position','redux-framework-demo'),
                'content' => __('Global Sidebar Position','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Blog Archive/Category Sidebar 1', 'redux-framework-demo'),
		...
		array (
            ...
            'title' => __('Activate Global Sidebar','redux-framework-demo'),
            'subtitle'  => __('Activate Global Sidebar', 'redux-framework-demo'),
            'desc' => __('Yes if you want to use a global sidebar on the main shop page and all single product pages. This option overrides the woocommerce options.','redux-framework-demo'),
            'on' => __('YES', 'redux-framework-demo'),
            'off' => __('NO ', 'redux-framework-demo'),
            'default' => 'No',
            'hint' => array(
		...
		array (
            ...
            'title' => __('Global Sidebar 2','redux-framework-demo'),
            'subtitle'  => __('Global Sidebar 2', 'redux-framework-demo'),
            'desc' => __('Select sidebar 2 that will display on all single product pages. Sidebar 2 can only be used if sidebar 1 is selected','redux-framework-demo'),
            'options' => aione_get_sidebars(),
			'default' => 'None',
			'hint' => array(
                'title'   => __('Global Sidebar 2','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Global Woocommerce Sidebar Position', 'redux-framework-demo'),
            'desc' => __('Select the sidebar 1 position for woocommerce. If sidebar 2 is selected, it will display on the opposite side.','redux-framework-demo'),
            'default' => 'Right',
            'hint' => array(
                'title'   => __('Global Woocommerce Sidebar Position','redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Woocommerce Archive/Category Sidebar 1', 'redux-framework-demo'),
            'desc' => __('Select sidebar 1 that will display on the archive/category pages.','redux-framework-demo'),
            'options' => aione_get_sidebars(),
			'default' => 'None',
			'hint' => array(
		...
		array (
            ...
            'subtitle'  => __('Woocommerce Archive/Category Sidebar 2', 'redux-framework-demo'),
            'desc' => __('Select sidebar 2 that will display on the archive/category pages. Sidebar 2 can only be used if sidebar 1 is selected.','redux-framework-demo'),
            'options' => aione_get_sidebars(),
			'default' => 'None',
			'hint' => array(
		...
		array (
            ...
            'subtitle'  => __('Search Page Sidebar 1', 'redux-framework-demo'),
		...
		array (
            ...
            'subtitle'  => __('Search Page Sidebar 2', 'redux-framework-demo'),
            'desc' => __('Select sidebar 2 that will display on the search results page. Sidebar 2 can only be used if sidebar 1 is selected.','redux-framework-demo'),
            'options' => aione_get_sidebars(),
			'default' => 'None',
			'hint' => array(
                'title'   => __('Search Page Sidebar 2','redux-framework-demo'),
		...
		array (
            ...
            'desc' => __('Select the sidebar 1 position for the search pages. If sidebar 2 is selected, it will display on the opposite side.','redux-framework-demo'),
            'default' => 'Right',
            'hint' => array(
                'title'   => __('Search Sidebar Position','redux-framework-demo'),
