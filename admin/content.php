...
if (!class_exists('theme_content')) {
    ...
    class theme_content {
        ...
        public function setSections() {
            ...
            require_once(dirname(__FILE__). '/options/content_general.php');
        ...
        public function setArguments() {
            ...
            $this->args = array(
                'opt_name' => 'theme_content',
                'display_name' => 'Theme Content',
                'display_version' => $this->theme->get('Version'),
                'ajax_save' => true,
                'page_slug' => 'content_settings',
                ...
                'admin_bar_icon' => 'dashicons-format-aside',
                'allow_sub_menu' => true,
