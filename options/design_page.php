...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'subtitle'  => __('Search Field Position.', 'redux-framework-demo'),
...
$this->sections[] = array(
    ...
    'fields'    => array(
		...
		array (
            ...
            'type' => 'select',
            'title' => __('Contact Form Commment Area Position','redux-framework-demo'),
            'subtitle'  => __('Contact Form Commment Area Position', 'redux-framework-demo'),
            'desc' => __('Set the position of the contact form comment area with respect to the other input fields.','redux-framework-demo'),
            'options' => array (
                'above' => 'Above',
                'below' => 'Below',
            ),
            ...
            'hint' => array(
                'title'   => __('Contact Form Commment Area Position','redux-framework-demo'),
                'content' => __('Contact Form Commment Area Position','redux-framework-demo'),
            )
        ),
        array (
            'id' => 'google_map',
